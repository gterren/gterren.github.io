...
<div style="text-align:center;">
  ...
  <p style="font-size:14px; color:#555;">
    Image processing embedded in the Girasol Machine: raw infrared image (left), atmospheric scatter radiation (middle), processed image (right).
  </p>
</div>
